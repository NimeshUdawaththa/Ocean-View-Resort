...
<div class="help-overlay" id="helpModal">
  <div class="help-modal">
    <div class="help-header">
      <h2>&#10067; Help &amp; Guide &mdash; Manager</h2>
    ...
    <div class="help-body">
      ...
      <div class="help-section">
        <h3>&#127968; Rooms</h3>
        <div class="help-row"><span class="help-icon">&#9998;</span><span><strong>Edit Room</strong> &mdash; Update room number, type, floor, description, and rate per night.</span></div>
        <div class="help-row"><span class="help-icon">&#128197;</span><span>Rooms become <strong>occupied</strong> on check-in and return to <strong>available</strong> on check-out.</span></div>
      </div>
      <div class="help-section">
        <h3>&#128101; Staff</h3>
        <div class="help-row"><span class="help-icon">&#128065;</span><span>The Staff tab shows all reception and manager accounts created by the admin.</span></div>
        <div class="help-row"><span class="help-icon">&#128683;</span><span>Contact an Administrator to add, edit, or deactivate staff accounts.</span></div>
      </div>
      <div class="help-section">
